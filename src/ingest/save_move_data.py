...
species_val   = np.load(pre + "move/species_val.npy", allow_pickle=True)

species_va_moves = species_val[move_idx_va]

np.save("data/processed/move/species_val.npy", species_va_moves)
